...
const updateFilter = (newValue) => {
    filterKnob.value = newValue;
    filter.value = newValue / 100;
    paramStore.requestParamValueUpdate('filter', filter.value);
};
</script>

<template>
    <div class="w-full h-full min-w-screen min-h-screen bg-gray-300 p-8 space-y-8">
        <div class="h-3/5 flex justify-between items-center text-md text-slate-400 select-none">
            <div class="h-8 w-auto text-slate-500">
                <svg class="w-6 h-6 text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 24 24">
                    <path d="M13.8 4.2a2 2 0 0 0-3.6 0L8.4 8.4l-4.6.3a2 2 0 0 0-1.1 3.5l3.5 3-1 4.4c-.5 1.7 1.4 3 2.9 2.1l3.9-2.3 3.9 2.3c1.5 1 3.4-.4 3-2.1l-1-4.4 3.4-3a2 2 0 0 0-1.1-3.5l-4.6-.3-1.8-4.2Z"/>
                </svg>
            </div>
            <div>
                <span class="font-bold">Dragon Audio</span>
            </div>
        </div>
        ...
        <div class="flex flex-col h-full mt-16">
            <div class="flex flex-row justify-center items-center space-x-8 mt-8">
                <div>
                    ...
                    <Knob v-model="sizeKnob" textColor="red" :size="100" @update:modelValue="updateSize" />
                </div>
                <div>
